...
| [腾讯云](https://cloud.tencent.com/document/product/1093/35682) | `录音文件识别极速版`：Host 通过 HTTPS 接口发送录音并接收同步转写结果 | AppID、SecretID、SecretKey 和 `engine_type` | [计费概述](https://cloud.tencent.com/document/product/1093/35686) |
