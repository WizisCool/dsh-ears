        ...
        types: [
          {
            ...
            declaration: 'export interface EarsSettingsView { available: boolean; writable: boolean; settings: EarsSettings; cloudAsrApiKeyConfigured: boolean; overridden: string[] }'
          },
          {
