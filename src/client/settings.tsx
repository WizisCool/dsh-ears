  ...
  return (
    <li className={`${styles.card} ${open ? styles.cardOpen : ''}`}>
      ...
      {open ? <div className={styles.body}>
        ...
        {selectedBackend && !selectedBackend.available ? <p className={`${styles.status} ${styles.invalid}`}>{t('backendUnavailable')}{backendUnavailableDetail(selectedBackend, t)}</p> : null}
