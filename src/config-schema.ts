...
export const EarsSettingsSchema = s.object({
  ...
  cloudAsr: s.object({
    ...
    tencent: s.object({
      ...
      engineType: s.string().default(DEFAULT_CLOUD_ASR_SETTINGS.tencent.engineType).description('Tencent Cloud Recording File Recognition Flash Edition engine_type'),
