...
export const EarsSettingsSchema = s.object({
  ...
  cloudAsrCustomApiKey: s.string().role('secret').default(DEFAULT_EARS_SETTINGS.cloudAsrCustomApiKey),
  cloudAsrBailianApiKey: s.string().role('secret').default(DEFAULT_EARS_SETTINGS.cloudAsrBailianApiKey),
  cloudAsrEndpoint: s.string().default(DEFAULT_EARS_SETTINGS.cloudAsrEndpoint),
  cloudAsrBailianHost: s.string().default(DEFAULT_EARS_SETTINGS.cloudAsrBailianHost),
