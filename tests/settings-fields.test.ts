...
describe('isSettingsFieldInvalid', () => {
  ...
  it('never marks an empty language field or a valid shortcut invalid', () => {
    ...
    expect(isSettingsFieldInvalid('cloudAsrSiliconFlowLanguage', '')).toBe(false)
    expect(isSettingsFieldInvalid('cloudAsrSiliconFlowLanguage', 'zh')).toBe(false)
    expect(isSettingsFieldInvalid('cloudAsrSiliconFlowLanguage', 'en-US')).toBe(false)
