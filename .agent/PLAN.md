...
4. Emotion recognition/UI stays deferred (D-015). Tencent Cloud's reserved big-model and real-time service protocols stay out of first-release scope.
