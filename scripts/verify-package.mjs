...
requireManifestValue('version', manifest.version, '0.3.1')
...
requireManifestValue('dependencies[@deepseek-ai/dsh-client-store]', manifest.dependencies?.['@deepseek-ai/dsh-client-store'], '0.1.5-rc.1')
