...
requireManifestValue('version', manifest.version, '0.3.2')
...
requireManifestValue('dependencies[@deepseek-ai/dsh-client-store]', manifest.dependencies?.['@deepseek-ai/dsh-client-store'], '0.1.5-rc.2')
