...
- dsh-ears 0.3.0 now requires dsh `>=0.1.2-rc.1`. Users who remain on dsh 0.1.1 must install dsh-ears `<0.3.0`.
...
- Direct dsh peer dependencies use the `>=0.1.2-rc.1` minimum; the compile baseline moves to exact `0.1.2-rc.1`, Cordis 4.0.2, and Schemastery 3.18.2.
