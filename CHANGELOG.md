...
- Synthesized voice-input sounds (no audio files): a short click on start/stop and a G5–C6 chime when listening actually begins. Toggle is in General, on by default.
